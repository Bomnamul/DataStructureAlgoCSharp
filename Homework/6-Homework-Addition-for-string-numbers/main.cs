...
class MainClass {
  public static void Main (string[] args) {
    ...
    Console.WriteLine(Add("123", "12") == "135");
    Console.WriteLine(Add("123", "10000") == "10123");
    Console.WriteLine(Add("0", "0") == "0");
    Console.WriteLine(Add("190000000000000000000008", "990000000000000000009999") == "1180000000000000000010007");
  }
